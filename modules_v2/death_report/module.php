...
class death_report_WT_Module extends WT_Module implements WT_Module_Report {
	...
	public function getTitle() {
		...
		return /* I18N: Name of a report */ WT_I18N::translate('Death Date and Place Report');
	}

	// Extend class WT_Module
	public function getDescription() {
		// This text also appears in the .XML file - update both together
		return /* I18N: Description of a report */ WT_I18N::translate('A report of people who died in a given time or place.');
	}
