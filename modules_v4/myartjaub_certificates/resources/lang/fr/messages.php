...
return array (
    ...
    'Certificate'                   =>  'Acte',
    'Certificate - %s'              =>  'Acte - %s',
    'Certificates for %s'           =>  'Actes pour %s',
    ...
    'Define access level of users who can see certificates without any watermark. By default, everybody will see the watermark.'
                                    =>  'Définit le niveau d\'accès des utilisateurs pouvant afficher les images d\'actes sans filigrane. Par défaut, tout le monde peut voir le filigrane.',
    ...
    'The certificate was not found in this family tree.'
                                    =>  'L\'acte n\'a pu être trouvé dans l\'arbre'
