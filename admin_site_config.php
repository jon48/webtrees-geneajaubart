...
echo
	...
	'<div class="site_config">',
		'<div id="tabs">',
			...
			'<dd>', edit_field_yes_no_inline('site_setting-STORE_MESSAGES', WT_Site::preference('STORE_MESSAGES'), $controller), '</dd>',
			...
			'<dd>', select_edit_control_inline('site_setting-SMTP_ACTIVE', array('internal'=>WT_I18N::translate('Use PHP mail to send messages'), 'external'=>WT_I18N::translate('Use SMTP to send messages'), 'disabled'=>WT_I18N::translate('Do not send messages')), null, WT_Site::preference('SMTP_ACTIVE'), $controller), '</dd>',
			...
			'<dd>', select_edit_control_inline('site_setting-SMTP_SSL', array('none'=>WT_I18N::translate('none'), 'ssl'=>WT_I18N::translate('ssl'), 'tls'=>WT_I18N::translate('tls')), null, WT_Site::preference('SMTP_SSL'), $controller), '</dd>',
